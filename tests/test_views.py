...
class TestViews(unittest.TestCase):
    ...
    @unittest.skip("Travis segfaulted")
    ...
    def test_create_assets(self):
        ...
        widget.sheet._pasteClipboard()
        widget._create()
        taxon_editor = widget.sheet.table._columns[0].editor(widget, None, None)
    ...
    def test_taxonomy_editor(self):
        ...
        editor = widget.sheet.table._columns[1].editor(None, None, index)
        self.assertIsInstance(editor, QtWidgets.QDialog)
        widget.sheet.table._columns[1].setter(editor, sheet_model, index)
